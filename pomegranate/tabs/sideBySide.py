...
'''
@callback(
    Output('adj-matrix-one', 'figure'),
    Output('adj-matrix-two', 'figure'),
...
def compareBySideTab ():
    return html.Div(className='side-by-side-tab-content', children=[
        ...
        dcc.Graph(id='adj-matrix-one', className='first-view tab-component'),
        dcc.Graph(id='adj-matrix-two', className='second-view tab-component'),    
    ])